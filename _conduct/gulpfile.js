...
var paths = {
    index: ['websrc/jsx/'+defaultAppName+'/index.html', 'launch.js', 'service.jsx'],
    l20n: ['websrc/global/vendor/l20n/*.jsx'],
    jsx: ['websrc/jsx/*.jsx', 'websrc/global/requires/*.js', 'websrc/jsx/**/*.jsx', 'websrc/jsx/**/**/*.jsx', 'websrc/jsx/**/**/**/*.jsx', '!websrc/global/vendor/l20n/*.jsx', '!src/global/vendor/bootstrap/*.jsx'],
    scss: ['public/fonts/web/*.ttf', 'websrc/sass/*.scss', 'websrc/sass/**/*.scss', 'websrc/sass/**/**/*.scss'],
    bootstrap: ['websrc/global/vendor/bootstrap/*.jsx'],
...
gulp.task('sass:app', function() {
    return gulp.src('./websrc/sass/'+defaultAppName+'/*.scss')
        .pipe(sass({
...
gulp.task('react:react', function() {
    return gulp.src('websrc/prebuild.jsx')
        .pipe(webpack({
            cache: true,
            module: {
                loaders: [
...
gulp.task('react:react-l20n', function() {
    return gulp.src('./websrc/global/vendor/l20n/index.jsx')
        .pipe(webpack({
            cache: true,
            module: {
                loaders: [
...
gulp.task('react:react-bootstrap', function() {
    return gulp.src('./websrc/global/vendor/bootstrap/index.jsx')
        .pipe(webpack({
            cache: true,
            module: {
                loaders: [
...
gulp.task('react:development', function() {
    var wconfig = {
        ...
        entry: [
            ...
            './websrc/jsx/'+defaultAppName+'/main.jsx'
        ],
        output: {
            path: process.cwd(),
...
gulp.task('react:app', function() {
    return gulp.src('websrc/jsx/'+defaultAppName+'/main.jsx')
        .pipe(webpack({
            cache: true,
            module: {
                loaders: [
...
gulp.task('react:concat', ['react:app'], function() {
    return gulp.src(['websrc/global/requires/*.js', 'public/js/'+defaultAppName+'/'+defaultAppName+'.js'])
...
gulp.task('base64-css:concat', ['base64-css:convert'], function() {
    return gulp.src(['public/css/fonts/'+defaultAppName+'/*.css'])
        .pipe(insert.prepend('@charset "UTF-8";\n'))
