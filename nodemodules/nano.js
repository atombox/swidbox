...
function abHttpAgent(req, callback)
{
...
module.exports = nano = function dbScope(cfg) {
  var serverScope = {};
  ...
  var httpAgent = (typeof cfg.request === 'function') ? cfg.request :
     /*request.defaults(cfg.requestDefaults)*/abHttpAgent;

  //var followAgent = (typeof cfg.follow === 'function') ? cfg.follow : follow;
  var log = typeof cfg.log === 'function' ? cfg.log : abLogger;
  ...
  function relax(opts, callback) {
    ...
    if (opts.body) {
      if (/*@mb Buffer.isBuffer(opts.body) ||*/ opts.dontStringify) {
        req.body = opts.body;
      }
      else {
